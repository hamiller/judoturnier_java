...
public class GewichtsklassenGruppeFixture {
    ...
    public static List<GewichtsklassenGruppe> gewichtsklassenGruppen = Arrays.asList(
            ...
            ), Optional.of(RandoriGruppenName.Eule), 25.8, 24.8),
            ...
            ), Optional.of(RandoriGruppenName.Katze), 26.8, 25.8),
            ...
            ), Optional.of(RandoriGruppenName.Maus), 27.8, 26.8),
    ...
    public static List<GewichtsklassenGruppe> gwks2 = Arrays.asList(
            ...
            ), Optional.of(RandoriGruppenName.Antilope), 26.8,24.8)
    );
