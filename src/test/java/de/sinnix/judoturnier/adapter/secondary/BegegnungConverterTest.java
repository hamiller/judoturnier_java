...
class BegegnungConverterTest {
	...
	public void testConvertFromBegegnung() {
		...
		Begegnung begegnung = new Begegnung(1, 2, 123, 22, WettkaempferFixtures.wettkaempfer1, WettkaempferFixtures.wettkaempfer2, Optional.of(wertung), new WettkampfGruppe(1, "Gruppe1", "typ1", List.of()));
